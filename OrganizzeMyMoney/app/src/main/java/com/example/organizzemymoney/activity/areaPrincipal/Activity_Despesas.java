...
public class Activity_Despesas extends AppCompatActivity implements  DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__despesas);

        date                 = findViewById(R.id.TV_DATA_ESCOLHA_DESPESAS);
        campoValor           = findViewById(R.id.TIL_Valor_Receitas);
        campoCategoria       = findViewById(R.id.campoCategoriaDespesas);
        campoDescricao       = findViewById(R.id.campoDescricaoDespesas);
    ...
    public void BTN_Confirma_Despesas(View v ){
        ...
        if (!textoValor.isEmpty()){
            if(!textoCategoria.isEmpty()){
                if (!textoDescricao.isEmpty()){
                    ...
                    Toast.makeText(Activity_Despesas.this, "Informe uma Descrição", Toast.LENGTH_LONG).show();
                    return false;
                }
            } else {
                Toast.makeText(Activity_Despesas.this, "Informe o Categoria", Toast.LENGTH_LONG).show();
                return false;
            }
        } else {
            Toast.makeText(Activity_Despesas.this, "Digite Valor", Toast.LENGTH_LONG).show();
            return false;
        }
    }
